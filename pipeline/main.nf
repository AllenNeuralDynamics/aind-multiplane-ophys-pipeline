...
// hash:sha256:c976970f90387de7154b6e6e407cd35bfa36b0cb10578c859952545adfb2c282
...
capsule_nwb_packaging_subject_capsule_13_to_capsule_aind_ophys_nwb_12_18 = channel.create()
ophys_mount_to_aind_ophys_nwb_19 = channel.fromPath(params.ophys_mount_url + "/", type: 'any')
ophys_mount_to_nwb_packaging_subject_capsule_20 = channel.fromPath(params.ophys_mount_url + "/", type: 'any')
...
process capsule_aind_ophys_nwb_12 {
	...
	input:
	path 'capsule/data/nwb/' from capsule_nwb_packaging_subject_capsule_13_to_capsule_aind_ophys_nwb_12_18.collect()
	path 'capsule/data/ophys_session' from ophys_mount_to_aind_ophys_nwb_19.collect()
...
process capsule_nwb_packaging_subject_capsule_13 {
	...
	input:
	path 'capsule/data/raw' from ophys_mount_to_nwb_packaging_subject_capsule_20.collect()

	output:
	path 'capsule/results/*' into capsule_nwb_packaging_subject_capsule_13_to_capsule_aind_ophys_nwb_12_18
