...
// hash:sha256:0923306a5a2e96820d2a6cfc86a288b1b66095b49562df60d0178240df3561bb
...
process capsule_aind_ophys_movie_qc_15 {
	...
	echo "[${task.tag}] cloning git repo..."
	if [[ "\$(printf '%s\n' "2.20.0" "\$(git version | awk '{print \$3}')" | sort -V | head -n1)" = "2.20.0" ]]; then
		git clone --filter=tree:0 --branch v6.0 "https://\$GIT_ACCESS_TOKEN@\$GIT_HOST/capsule-0300037.git" capsule-repo
	else
